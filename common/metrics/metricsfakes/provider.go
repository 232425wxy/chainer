...
func (fake *Provider) SetNewCounterStub(stub func(metrics.CounterOpts) metrics.Counter) {
	fake.newCounterMutex.Lock()
...
func (fake *Provider) SetNewCounterReturns(result1 metrics.Counter) {
	fake.newCounterMutex.Lock()
	defer fake.newCounterMutex.Unlock()
	fake.NewCounterStub = nil
	fake.newCounterReturns = struct{ result1 metrics.Counter }{result1}
}

func (fake *Provider) SetNewCounterReturnsOnCall(i int, result1 metrics.Counter) {
	fake.newCounterMutex.Lock()
	defer fake.newCounterMutex.Unlock()
	fake.NewCounterStub = nil
	if fake.newCounterReturnsOnCall == nil {
		fake.newCounterReturnsOnCall = make(map[int]struct{ result1 metrics.Counter })
	}
	fake.newCounterReturnsOnCall[i] = struct{ result1 metrics.Counter }{result1}
}
...
func (fake *Provider) SetNewGaugeStub(stub func(metrics.GaugeOpts) metrics.Gauge) {
	fake.newGaugeMutex.Lock()
...
func (fake *Provider) SetNewGaugeRetruns(result1 metrics.Gauge) {
	fake.newGaugeMutex.Lock()
	defer fake.newGaugeMutex.Unlock()
	fake.NewGaugeStub = nil
	fake.newGaugeReturns = struct{ result1 metrics.Gauge }{result1}
}

func (fake *Provider) SetNewGaugeReturnsOnCall(i int, result1 metrics.Gauge) {
	fake.newGaugeMutex.Lock()
	defer fake.newGaugeMutex.Unlock()
	fake.NewGaugeStub = nil
	if fake.newGaugeReturnsOnCall == nil {
		fake.newGaugeReturnsOnCall = make(map[int]struct{ result1 metrics.Gauge })
	}
	fake.newGaugeReturnsOnCall[i] = struct{ result1 metrics.Gauge }{result1}
}
...
func (fake *Provider) NewHistogram(arg1 metrics.HistogramOpts) metrics.Histogram {
	...
	ret, specificReturn := fake.newHistogramReturnsOnCall[len(fake.newHistogramReturnsOnCall)]
	fake.newHistogramArgsForCall = append(fake.newHistogramArgsForCall, struct{ arg1 metrics.HistogramOpts }{arg1})
...
func (fake *Provider) SetNewhistogramStub(stub func(metrics.HistogramOpts) metrics.Histogram) {
	fake.newHistogramMutex.Lock()
...
func (fake *Provider) SetNewHistogramReturns(result1 metrics.Histogram) {
	fake.newHistogramMutex.Lock()
	defer fake.newHistogramMutex.Unlock()
	fake.NewHistogramStub = nil
	fake.newHistogramReturns = struct{ result1 metrics.Histogram }{result1}
}

// NewHistogramReturnsOnCall 将 NewHistogramStub 置为 nil，然后在 newHistogramReturnsOnCall 的对应位置设置将来返回的 Histogram。
func (fake *Provider) SetNewHistogramReturnsOnCall(i int, result1 metrics.Histogram) {
	fake.newHistogramMutex.Lock()
	defer fake.newHistogramMutex.Unlock()
	fake.NewHistogramStub = nil
	if fake.newHistogramReturnsOnCall == nil {
		fake.newHistogramReturnsOnCall = make(map[int]struct{ result1 metrics.Histogram })
	}
	fake.newHistogramReturnsOnCall[i] = struct{ result1 metrics.Histogram }{result1}
}
